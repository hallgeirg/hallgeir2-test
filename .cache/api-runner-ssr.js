var plugins = [{
      plugin: require('/Users/hallgeirg/GitHub/gatsby-starter-lumen/hallgeir2-test/node_modules/gatsby-plugin-feed/gatsby-ssr'),
      options: {"plugins":[],"query":"\n          {\n            site {\n              siteMetadata {\n                site_url: url\n                title\n                description: subtitle\n              }\n            }\n          }\n        ","feeds":[{"query":"\n              {\n                allMarkdownRemark(\n                  limit: 1000,\n                  sort: { order: DESC, fields: [frontmatter___date] },\n                  filter: { frontmatter: { template: { eq: \"post\" }, draft: { ne: true } } }\n                ) {\n                  edges {\n                    node {\n                      html\n                      fields {\n                        slug\n                      }\n                      frontmatter {\n                        title\n                        date\n                        template\n                        draft\n                        description\n                      }\n                    }\n                  }\n                }\n              }\n            ","output":"/rss.xml"}]},
    },{
      plugin: require('/Users/hallgeirg/GitHub/gatsby-starter-lumen/hallgeir2-test/node_modules/gatsby-plugin-google-analytics/gatsby-ssr'),
      options: {"plugins":[],"trackingId":"UA-73379983-2"},
    },{
      plugin: require('/Users/hallgeirg/GitHub/gatsby-starter-lumen/hallgeir2-test/node_modules/gatsby-plugin-sitemap/gatsby-ssr'),
